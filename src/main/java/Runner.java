...
//        System.out.println("The rectangle has an area of " + area);
        int area = rectangle.area(10,5);
        System.out.println("The rectangle has an area of " + area);



        // 3. Check if your rectangle is actually a square
        boolean isRectangle = rectangle.isRectangle(6,5);
    ...
    public static void computerDemo(){
        ...
        Computer computer = new Computer(256, "Macbook");
...
//        String currentPrinter = computer.setPrinterModel("EPSON");
